      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-slate-950 hover:bg-slate-900 text-white text-xs font-bold rounded-xl transition shadow-xs border border-slate-800"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-semibold rounded-xl transition"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              View all <ArrowUpRight className="w-3 h-3 text-lime-600" />
            </button>
          </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {onSelectMemberForPayment && (
                      <button
                        ...
                        className="px-2.5 py-1 bg-slate-950 hover:bg-slate-900 text-white font-bold rounded-lg text-[11px] transition shadow-2xs"
                      >
                        Renew
                      </button>
                    )}
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="text-xs font-bold text-slate-800 hover:text-slate-950 hover:underline flex items-center gap-1"
            >
              Live Log <ArrowUpRight className="w-3 h-3 text-lime-600" />
            </button>
          </div>
